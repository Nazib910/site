          ...
          <div className="relative overflow-hidden w-full h-full flex justify-end px-4 sm:px-8 md:px-12 text-right items-start py-6 sm:py-8 md:py-12 text-primary-foreground">
            ...
            >
              <ul className="space-y-1 sm:space-y-2">
                ...
                <li className="hover:underline cursor-pointer transition-colors">Services</li>
                <li className="hover:underline cursor-pointer transition-colors">Contact</li>
              </ul>
              <ul className="space-y-1 sm:space-y-2">
                <li className="hover:underline cursor-pointer transition-colors">Github</li>
                <li className="hover:underline cursor-pointer transition-colors">Twitter</li>
                <li className="hover:underline cursor-pointer transition-colors">LinkedIn</li>
              </ul>
            </motion.div>
            <motion.h2
