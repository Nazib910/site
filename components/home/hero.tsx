          ...
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            >
              <h1 id="main-title" className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight text-foreground">
                Professional SaaS <strong>Solutions</strong> <span>&</span> <br />
            ...
            >
              We craft custom web applications, mobile solutions, and user-centered designs for startups and enterprises. From concept to deployment, we deliver excellence.
            </motion.p>
