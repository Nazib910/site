        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          >
            ...
            <p className="text-base md:text-lg text-muted-foreground mb-6 leading-relaxed">
              SRCDrive is a forward-thinking software development agency dedicated to transforming innovative ideas into powerful digital solutions. We combine cutting-edge technology with strategic thinking to deliver exceptional results for our clients.
            </p>
            <p className="text-base md:text-lg text-muted-foreground mb-8 leading-relaxed">
              Our team of experienced developers, designers, and strategists work collaboratively to ensure every project exceeds expectations. We're passionate about technology and committed to your success.
            </p>
