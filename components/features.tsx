      ...
      >
        ...
        <div className="w-full cursor-none">
          <div className="grid grid-cols-12 gap-4 justify-center">
            {/* Web Development */}
            <motion.div
              className="group border-border/50 text-card-foreground relative col-span-12 flex flex-col overflow-hidden rounded-xl border-2 p-4 sm:p-6 shadow-lg transition-all ease-in-out md:col-span-6 xl:col-span-6 xl:col-start-2"
              ref={ref}
              initial={{ opacity: 0, y: 50 }}
              animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 50 }}
            ...
            >
              <div className="flex flex-col gap-3 sm:gap-4">
                <h3 className="text-xl sm:text-2xl leading-tight font-semibold tracking-tight">Web Development</h3>
                <div className="text-sm md:text-base text-muted-foreground flex flex-col gap-2">
                  <p className="max-w-[460px]">
                    Modern web applications built with cutting-edge technologies. Responsive design, high performance, and scalable architecture for enterprise-grade solutions.
                  </p>
                </div>
              </div>
            ...
            <motion.div
              className="group border-border/50 text-card-foreground relative col-span-12 flex flex-col overflow-hidden rounded-xl border-2 p-4 sm:p-6 shadow-lg transition-all ease-in-out md:col-span-6 xl:col-span-6 xl:col-start-8"
              ref={ref}
              initial={{ opacity: 0, y: 50 }}
              animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 50 }}
            ...
            >
              <div className="flex flex-col gap-3 sm:gap-4">
                <h3 className="text-xl sm:text-2xl leading-tight font-semibold tracking-tight">Mobile App Development</h3>
                <div className="text-sm md:text-base text-muted-foreground flex flex-col gap-2">
                  <p className="max-w-[460px]">
                    Native and cross-platform solutions for iOS and Android. User-friendly interfaces, smooth performance, and seamless cloud integration.
                  </p>
                </div>
              </div>
            ...
            >
              <div className="flex flex-col gap-3 sm:gap-4">
                <h3 className="text-xl sm:text-2xl leading-tight font-semibold tracking-tight">UI/UX Design</h3>
                <div className="text-sm md:text-base text-muted-foreground flex flex-col gap-2">
                  <p className="max-w-[460px]">
                    User-centered design approaches creating beautiful, intuitive interfaces. Accessibility-first design ensuring your users have the best experience.
                  </p>
                </div>
              </div>
            ...
            >
              <div className="flex flex-col gap-3 sm:gap-4">
                <h3 className="text-xl sm:text-2xl leading-tight font-semibold tracking-tight">Cloud Solutions</h3>
                <div className="text-sm md:text-base text-muted-foreground flex flex-col gap-2">
                  <p className="max-w-[460px]">
                    Scalable, secure infrastructure on AWS, Azure, or GCP. Database optimization, security hardening, and disaster recovery planning.
                  </p>
                </div>
              </div>
              <div className="flex grow items-center justify-center select-none relative min-h-64 sm:min-h-80 md:min-h-96 p-4 mt-4 sm:mt-6">
            ...
            >
              <div className="flex flex-col gap-3 sm:gap-4">
                <h3 className="text-xl sm:text-2xl leading-tight font-semibold tracking-tight">Custom Software Development</h3>
                <div className="text-sm md:text-base text-muted-foreground flex flex-col gap-2">
                  <p className="max-w-[460px]">
                    Tailored solutions for complex business problems. Enterprise software, custom integrations, API development, and system architecture designed specifically for your needs.
                  </p>
                </div>
              </div>
